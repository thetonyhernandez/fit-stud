...
function ExerciseDemo({title,videoId,desc,demo,t}){
  ...
  return <div>
    {demo&&demo.gif
      ...
      : <a href={"https://www.youtube.com/results?search_query="+encodeURIComponent(title+" exercise form")} target="_blank" rel="noopener noreferrer" style={{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:6,width:"100%",height:140,borderRadius:16,background:t.card,border:"1px solid "+t.cardBorder,marginBottom:12,textDecoration:"none"}}><div style={{fontSize:30}}>▶</div><div style={{fontSize:13,color:t.accentText,fontWeight:700}}>Watch on YouTube</div><div style={{fontSize:11,color:t.textMuted}}>No demo clip for this one yet</div></a>}
    ...
    {demo&&demo.gif&&<a href={"https://www.youtube.com/results?search_query="+encodeURIComponent(title+" exercise form")} target="_blank" rel="noopener noreferrer" style={{display:"block",textAlign:"center",fontSize:12,color:t.textMuted,marginTop:12,textDecoration:"none"}}>Prefer a video? Watch on YouTube ↗</a>}
  </div>;
}
let nextId=200;
export default function FitStud() {
  ...
  useEffect(()=>{const resetToToday=()=>{const d=new Date();setSelectedDay(DAYS[d.getDay()]);setSelectedDateKey(dayKeyOf(d));};const onVis=()=>{if(document.visibilityState==="visible")resetToToday();};document.addEventListener("visibilitychange",onVis);return ()=>document.removeEventListener("visibilitychange",onVis);},[]);
  ...
  const QUOTES=["Every workout is a deposit in the bank of your future.","Today's effort earns tomorrow's confidence.","You invested in yourself today. That's always a smart investment.","Every session pays dividends.","Great bodies are built through daily deposits.","The return on today's workout lasts a lifetime.","Every rep increases your future value.","Your future self is collecting today's rewards.","Today's discipline compounds tomorrow.","Every workout grows your greatest asset—you.","Nothing invested in yourself is ever wasted.","Today's sweat becomes tomorrow's strength.","Every session adds value to your life.","Your future is funded by today's effort.","Keep investing. The results are coming.","Strong futures are built through small deposits.","Your body remembers every investment you make.","Every workout increases your confidence account.","Consistency has the highest return.","Every session earns interest.","Your future body is under construction.","Today's effort creates lifelong returns.","Every workout is a long-term investment.","Keep investing in your health.","Success compounds daily.","You just made another deposit.","Great things grow through consistency.","Every session builds wealth you can feel.","Health is the greatest investment.","You can't lose by investing in yourself.","Today's effort is tomorrow's advantage.","The strongest portfolios are built over time.","Every workout increases your value.","Another investment completed.","Your future grows stronger every session.","Every drop of sweat earns interest.","Today's work multiplies tomorrow.","Keep adding to your future.","Every completed workout pays you back.","Nothing compounds like discipline.","Small deposits create massive change.","Today's investment becomes tomorrow's confidence.","You funded your future today.","Every workout is another brick in your foundation.","Strong habits create lifelong wealth.","Today's work is your future's greatest gift.","Progress compounds quietly.","Keep building your strongest investment.","You just increased your future potential.","The best investment account is your body.","Every session strengthens your future.","Today's consistency creates tomorrow's freedom.","Another day invested wisely.","Success is built through daily contributions.","Time invested today saves regret tomorrow.","Every workout pays you twice.","The strongest returns require patience.","Great physiques are earned through consistent deposits.","Every session is another payment toward your goals.","Today's effort is tomorrow's reward.","One workout at a time, fortunes are built.","The investment always comes back stronger.","Progress compounds when you stay consistent.","Nothing pays better than self-discipline.","You invested an hour. You'll gain years.","Today's workout is tomorrow's confidence.","Keep growing your greatest asset.","Your future is worth today's effort.","Great investments require consistency.","Every workout builds invisible wealth.","Another investment made.","Every session increases your strength portfolio.","The body you want is purchased with daily effort.","Keep making smart investments.","Every finish increases your future value.","You just paid yourself first.","Every workout creates lasting dividends.","The greatest wealth is good health.","Today's investment becomes tomorrow's pride.","Every session earns future respect.","Keep funding your transformation.","Today's sweat has lifelong value.","Progress is built through repeated investments.","Every workout makes your future richer.","One hour invested. A lifetime gained.","Nothing appreciates faster than discipline.","Your effort is appreciating every day.","Every workout strengthens your foundation.","Consistency is your greatest investment strategy.","Today's commitment builds tomorrow's confidence.","Great returns come from daily effort.","Another investment. Another step forward.","Every session builds something priceless.","Your future is already thanking you.","Keep making deposits.","You earned another return today.","Progress is always worth the investment.","Every workout builds a stronger tomorrow.","Your greatest investment will always be yourself.","The mirror always catches up to consistency.","Results arrive quietly before they're ever noticed.","Every great transformation begins with ordinary days.","Your habits are introducing you to your future.","The work you repeat becomes the life you live.","Progress rewards patience.","The hardest workouts often leave the greatest lessons.","Every finish teaches your mind to keep going.","You become what you repeatedly choose.","The body follows where the mind leads.","Discipline is remembered long after motivation is forgotten.","Every completed workout makes the next decision easier.","Confidence is built through kept promises.","You don't find strength. You build it.","Success is hidden inside ordinary days.","Growth is usually invisible until one day it isn't.","The strongest people simply refuse to stop.","Small victories deserve great respect.","Consistency is a quiet superpower.","Great things happen one workout at a time.","Time rewards those who stay committed.","Every rep teaches resilience.","Patience has built more champions than talent.","What feels difficult today becomes normal tomorrow.","Progress begins the moment excuses end.","Your future is shaped by your routines.","Ordinary effort becomes extraordinary results.","Every workout is a conversation with your future self.","Strong minds create strong bodies.","Your standards determine your future.","Excellence is built through repetition.","Today's discipline is tomorrow's confidence.","Every workout leaves something behind and builds something new.","The process always remembers your effort.","You become stronger long before you notice it.","Growth happens while nobody is watching.","Every workout is another chance to become yourself.","Great habits create great lives.","Consistency speaks louder than intensity.","One decision repeated daily changes everything.","Time never ignores discipline.","Every finish builds trust in yourself.","Small actions shape big futures.","Your future body begins with today's choices.","Keep becoming someone you're proud to be.","Every session teaches patience.","Your greatest competition is yesterday.","The strongest roots grow quietly.","Today's effort becomes tomorrow's confidence.","Results are earned before they're seen.","Every workout is another lesson in perseverance.","Success is rarely dramatic.","Consistency always leaves clues.","Greatness grows in silence.","You don't need perfect days—just faithful ones.","Every finish rewrites your story.","Small improvements never stay small.","You become what you consistently practice.","The strongest foundation is built one brick at a time.","Nothing meaningful happens overnight.","Every completed workout is proof of possibility.","Discipline builds a life motivation never could.","Time reveals the value of consistency.","Your future is listening to today's choices.","Every workout plants another seed.","Strong habits outlast strong emotions.","Every session reminds you who you're becoming.","The work always finds its reward.","Keep honoring your commitments.","Progress favors those who return tomorrow.","The best transformations are earned quietly.","Every finish teaches your mind to trust itself.","Lasting change is built through ordinary decisions.","One workout can't change your life. Thousands can.","Your actions always tell the truth.","Every workout is another opportunity fulfilled.","Nothing strengthens confidence like consistency.","Stay patient with the process.","The version of you that keeps showing up always wins.","Progress doesn't rush.","Every day is another chance to improve your story.","Trust what repeated effort can do.","Today's effort becomes tomorrow's freedom.","Every finish makes tomorrow's choice easier.","Success is built before it's celebrated.","Every workout leaves you wiser.","You grow every time you choose discipline.","Time remembers consistency.","Every session strengthens more than muscle.","You don't need permission to improve.","The journey is changing you.","Every workout is another vote for excellence.","Keep trusting your effort.","Great things take longer than excuses.","Your future is being written today.","Every finish is another promise fulfilled.","Keep becoming the person your goals deserve.","The strongest victories are the ones nobody sees.","Today's effort will echo into tomorrow.","The person you become is built by the choices nobody applauds.","Every day you choose discipline, life becomes a little easier.","Your future is shaped by what you repeatedly do.","Progress is patient. Be patient with yourself.","The strongest victories are the ones over yourself.","Every workout is a reminder that you're capable of more.","Time always rewards consistency.","Nothing meaningful is built in a hurry.","You don't have to be perfect. You have to return.","The body follows the habits of the mind.","Every finish is another reason to believe.","Consistency creates opportunities that motivation never could.","Small victories become extraordinary lives.","The hardest road often leads to the greatest view.","Every workout teaches your mind something your body will remember.","Confidence is earned in private.","The work you repeat becomes the person you become.","Progress starts long before it's visible.","Patience is a form of strength.","Your standards become your lifestyle.","The strongest habits are built on ordinary days.","Every promise you keep strengthens your character.","The mirror reflects yesterday's decisions.","Tomorrow begins with today's choices.","Discipline quietly changes everything.","Growth rarely asks for permission.","Every finish plants another seed.","Keep choosing the harder right over the easier wrong.","Results never forget consistent effort.","Strength is built before it's seen.","The quiet days matter most.","Every workout proves you're still moving forward.","Consistency is the language of progress.","The greatest investment is becoming someone you respect.","Keep honoring your future.","Ordinary effort creates extraordinary outcomes.","The strongest people never stop learning.","Every rep carries purpose.","Progress belongs to those who stay.","The work will always introduce you to a better version of yourself.","Stay committed to who you're becoming.","Every finish creates another beginning.","Character is built through repetition.","Your future remembers today's discipline.","You can't rush becoming your best.","The process is changing you, even when you can't see it.","One decision repeated daily changes a life.","Every workout makes the next choice easier.","Trust your consistency.","Small actions create remarkable futures.","Keep earning your confidence.","Nothing replaces showing up.","Every finish is another promise kept.","Strong people are built quietly.","The strongest roots grow unseen.","Every day you return, you become harder to stop.","The work is becoming part of you.","Greatness is patient enough to wait.","You don't need more time. You need another day.","Every workout is another chapter completed.","The strongest foundations are never rushed.","Every session teaches resilience.","The next level is built one day at a time.","Every finish makes tomorrow possible.","Stay loyal to your future.","Every workout carries tomorrow inside it.","Progress rewards those who return.","Every decision becomes a habit.","Every habit becomes a lifestyle.","Every lifestyle becomes your story.","Your story is still being written.","Keep writing it well.","The greatest victories begin with small decisions.","Every finish builds another layer of confidence.","Consistency creates quiet confidence.","Every session has purpose.","Growth is always worth the wait.","The strongest people are patient with themselves.","Keep becoming someone you admire.","Every workout is another chance to improve your life.","Every day is another opportunity to honor yourself.","Time respects disciplined people.","Your effort today echoes into tomorrow.","Every finish matters.","Stay faithful to the process.","The life you want is built through repetition.","You are stronger because you stayed.","Every workout teaches perseverance.","Keep becoming undeniable.","Another day. Another lesson.","Another workout. Another victory.","The journey continues.","The life you want is built by the choices you repeat.","Every workout is proof that you're becoming stronger than your excuses.","Your future is created one decision at a time.","The strongest people simply refuse to stop showing up.","Success begins the moment consistency becomes your standard.","Your body follows where your discipline leads.","Nothing changes until your habits do.","Greatness is never found. It's built.","The mirror always tells the truth—just not immediately.","The hardest step will always be the first one.","Every workout is another chance to rewrite your story.","Discipline is the bridge between who you are and who you're becoming.","The future rewards those who prepare today.","You become what you practice.","Every rep teaches your mind to keep going.","Time never ignores consistency.","You don't need permission to improve your life.","The strongest investment you'll ever make is in yourself.","Great lives are built through ordinary decisions.","Your standards create your future.","Every workout is another vote for the person you want to become.","Keep your promises, especially the ones you make to yourself.","Progress begins where excuses end.","Every completed workout becomes part of your character.","The strongest people aren't fearless. They're faithful.","Consistency turns effort into identity.","Nothing worthwhile is built overnight.","Stay patient with your progress.","You don't need a new plan. You need another day.","One disciplined day can change a lifetime.","Your future self is shaped by today's choices.","Every finish makes tomorrow easier.","Build habits your future self will thank you for.","Growth is earned through repetition.","The strongest victories happen in private.","Confidence is built through action.","You already survived the hardest part—you started.","Every finish proves you're capable of more.","The work is always worth it.","One workout won't change your life.","But the next one might.","And the one after that.","Keep going.","The person you admire is built through days like today.","Your effort today becomes someone else's inspiration tomorrow.","Every session is another chance to rise.","Greatness belongs to those who return.","You didn't come this far to become average.","Your consistency is becoming your superpower.","Every workout is a quiet act of self-respect.","Keep choosing the life you deserve.","You earn confidence one promise at a time.","Your future is waiting on your consistency.","Every finish leaves you stronger than before.","Build a life that doesn't need excuses.","Every challenge carries an opportunity to grow.","Stay committed long enough to surprise yourself.","Progress is built by those who refuse to quit.","Keep becoming difficult to defeat.","Every workout writes another page of your story.","The strongest foundation is built one day at a time.","The version of you you're chasing is waiting on tomorrow's workout.","Success isn't a destination. It's a daily decision.","Never underestimate another completed workout.","You are becoming the person your goals require.","One day you'll thank yourself for not giving up today.","Build your future before you need it.","The strongest habit you'll ever build is showing up.","Let consistency become your signature.","Every workout is another opportunity to lead yourself.","Keep earning your own respect.","Great transformations begin with ordinary decisions.","The work you do today becomes the strength you carry tomorrow.","You are one decision away from a better future.","Stay disciplined. Stay patient. Stay moving.","Every finish is another victory over yesterday.","The greatest project you'll ever work on is yourself.","Strong habits create extraordinary lives.","Keep investing in the person you're becoming.","The mirror will catch up. Don't stop now.","Every workout brings your future closer.","Every session leaves something behind and builds something better.","The strongest version of you is under construction.","Keep building.","Keep believing.","Keep showing up.","Your future deserves today's effort.","Never stop earning the life you want.","The journey continues tomorrow.","Your legacy is built one workout at a time.","Thank you for choosing yourself today. We'll be here when you're ready to do it again.","You're becoming someone who keeps their promises.","This is what disciplined people do.","Every workout strengthens your identity.","You're no longer hoping for change—you're creating it.","Strong people are built through consistent choices.","You showed yourself who you are today.","Your actions define you more than your intentions.","You are becoming someone who finishes what they start.","This is the new standard you set for yourself.","Every workout reinforces the person you're becoming.","You don't wait for motivation—you create momentum.","Your identity is built through repetition.","Today, you acted like the person you want to become.","Winners don't happen by accident.","You're building a reputation with yourself.","Confidence comes from keeping your word.","Every completed workout earns self-respect.","This is what commitment looks like.","You proved yourself right today.","You're becoming harder to break.","The strongest version of you is already taking shape.","Discipline is becoming part of who you are.","You don't skip. That's who you are now.","Your habits are becoming your identity.","Strong people aren't born. They're built.","You are living your standards.","You chose growth again.","Every workout says something about you.","Today, your actions matched your goals.","You don't chase discipline anymore—you live it.","You're becoming someone others will admire.","This is how confidence is earned.","Every workout makes quitting less like you.","Your consistency is becoming your signature.","You're building trust with yourself.","Every finish strengthens your character.","This is what resilience looks like.","You showed integrity today.","You followed through.","Every workout confirms who you are.","You chose excellence over excuses.","Your future self is being shaped by today's choices.","Discipline is no longer something you do—it's becoming who you are.","You are becoming reliable.","Every workout is another promise fulfilled.","You're creating a life your future self will respect.","The strongest identities are built through small daily victories.","You acted with purpose today.","This is how champions think.","You chose action over comfort.","You continue proving yourself capable.","Strong identities are earned.","You don't need perfect—you need consistent.","Today wasn't luck. It was character.","You're becoming someone who always shows up.","One workout doesn't define you. Your consistency does.","You are writing a new story.","Your standards just got stronger.","You don't make excuses—you make progress.","Every workout reinforces your mindset.","Your discipline is becoming effortless.","You did what you said you'd do.","That matters.","Keep becoming impossible to stop.","You're stronger than your old habits.","Today, you chose your future.","Every session shapes your identity.","This is the person your goals require.","You continue becoming your best self.","Your future starts recognizing you.","Every workout makes discipline more natural.","You built confidence today.","You are becoming someone who never gives up.","Your actions are speaking louder than your doubts.","The strongest identity is built one decision at a time.","You're becoming someone who earns results.","Your commitment is changing you.","You proved that consistency is part of your character.","Today, you became a little more resilient.","Your standards continue to rise.","You don't stop when it gets difficult.","That's who you are.","Every finish builds belief.","You continue earning your own respect.","Strong people keep showing up.","You did it again.","That's becoming your identity.","Every workout strengthens your discipline.","You continue becoming someone who follows through.","This is what self-respect looks like.","You earned another reason to believe in yourself.","Keep becoming the person you admire.","You're creating habits that define greatness.","Today, your actions reflected your values.","This is how lasting confidence is built.","Every session reminds you of what's possible.","You are becoming the kind of person who never needs an excuse.","This is who you are now.","Every workout leaves a legacy.","Build a body your future will thank you for.","The life you want is forged one workout at a time.","Great legacies begin with ordinary days.","Every session shapes the story you'll tell.","Build something you'll be proud to look back on.","Today's discipline becomes tomorrow's legacy.","Leave proof that you showed up.","The strongest legacy is built through consistency.","Every rep writes another chapter.","The future remembers what you do today.","Build a life worth remembering.","The work you do today outlives today.","Legacy isn't found. It's built.","Keep building something meaningful.","Every workout is another brick in your legacy.","Make today's effort part of your story.","Build a future your younger self would admire.","Every finish leaves a mark.","One workout won't define you. Years of consistency will.","Build the version of yourself you've always respected.","Your legacy starts with today's choices.","Every workout is another opportunity to become unforgettable.","Keep writing your story.","Build something that lasts.","Your actions today become your memories tomorrow.","Every workout becomes part of your history.","Live in a way your future self will celebrate.","Leave excuses behind.","Leave effort behind.","Every day you show up, your legacy grows.","Great stories are written through consistent action.","The strongest people build quietly.","Every session leaves evidence.","The future belongs to those who prepare today.","Keep becoming someone worth remembering.","Build your body. Build your character.","Build your habits. Build your future.","Build something bigger than motivation.","Every finish adds another page.","The strongest legacy is consistency.","Make today's effort count for years.","Build a future that inspires you.","Your legacy is built long before anyone notices.","Every session becomes part of your character.","Keep creating a life you're proud of.","Leave today's workout better than you found it.","The strongest foundations are built slowly.","Every rep becomes part of your story.","One decision repeated daily changes generations.","Build a standard others will respect.","Your future family benefits from today's discipline.","Strong examples are built through actions.","Legacy begins with self-discipline.","Build something your children would admire.","Every workout plants seeds you'll harvest later.","Leave behind excuses.","Leave behind strength.","Every workout honors the person you're becoming.","Build a body that supports your purpose.","Keep becoming someone who inspires others.","Every session is another opportunity to lead by example.","Build a future worth fighting for.","Today's discipline becomes tomorrow's influence.","The strongest leaders first master themselves.","Every workout shapes more than your body.","Build a life that reflects your values.","The work you do today echoes tomorrow.","Every finish leaves a lasting impression.","Keep earning your future.","Build confidence that can't be taken away.","Great legacies aren't rushed.","They're repeated.","Every workout strengthens your purpose.","Build something your future self will never regret.","Every session leaves you stronger than yesterday.","Keep investing in the story you're writing.","The life you admire is built through habits.","Every day matters.","Every workout matters.","Leave proof that you believed in yourself.","Build your standards.","Build your future.","Every rep is another reason to be proud.","Build the life you've imagined.","Greatness is remembered because it was repeated.","Every workout becomes part of your legacy.","Build something that lasts longer than motivation.","Your discipline is becoming your signature.","Leave today's workout knowing you gave your best.","Keep building your legacy.","One session closer to the life you want.","Every finish is another milestone.","Your story deserves consistency.","Build your future with today's effort.","Your legacy is forged one workout at a time.","Champions are built long before they're recognized.","Every champion started with one workout.","Champions train when nobody is watching.","Greatness is earned through repetition.","Champions don't skip the basics.","Standards create champions.","Every workout is championship training.","Champions keep showing up.","Excellence is a daily decision.","Greatness hides inside consistency.","Champions don't wait for perfect conditions.","Every completed workout sharpens your edge.","Champions respect the process.","Discipline is a champion's greatest strength.","The work nobody sees creates the results everyone notices.","Every rep has purpose.","Champions finish what they start.","Greatness begins with ordinary discipline.","Every session separates you from yesterday.","Champions earn confidence through action.","The best never stop improving.","Champions compete with themselves first.","The next level is earned, not given.","Every workout prepares you for bigger moments.","Greatness is practiced daily.","Champions trust consistency.","Success follows disciplined routines.","The strongest competitors master themselves first.","Champions never waste today's opportunity.","Every session moves you closer to excellence.","Greatness is patient.","Champions stay committed long after excitement fades.","Every workout is another opportunity to improve.","Elite habits build elite lives.","Champions respect every rep.","Success belongs to those who return tomorrow.","Greatness is never accidental.","Champions embrace the difficult days.","Every finish strengthens your mindset.","Elite performance starts with ordinary habits.","Champions never underestimate small victories.","Greatness is earned quietly.","The best don't chase shortcuts.","Champions understand that progress compounds.","Every workout reinforces excellence.","Elite people honor their commitments.","Champions train through inconvenience.","Consistency separates champions from everyone else.","Greatness grows through patience.","Champions know the work is never wasted.","Elite standards create elite results.","Champions win today's battle first.","Excellence starts before anyone notices.","Champions build momentum daily.","Success is simply disciplined repetition.","Elite results follow ordinary consistency.","Champions never stop learning.","Every workout prepares you for tomorrow.","Greatness belongs to those who stay.","Champions focus on the next rep.","Excellence is built through thousands of small victories.","Champions choose action over excuses.","Every finish deserves respect.","Champions don't need applause.","The strongest competitors never stop growing.","Every session makes you more prepared.","Champions build confidence one workout at a time.","Elite performance begins with disciplined habits.","Champions understand that every day matters.","Every workout is another chance to improve.","Greatness is built in silence.","Champions remain students.","Every session sharpens your character.","Champions master consistency.","Greatness rewards persistence.","Every workout builds your advantage.","Champions train with intention.","Excellence is earned before it's recognized.","Every completed workout is championship practice.","Champions are defined by their habits.","Greatness requires another day of discipline.","Champions stay humble enough to improve.","Elite results demand elite consistency.","Every session strengthens your resolve.","Champions don't count the days—they make the days count.","Greatness starts with showing up.","Champions never stop earning it.","Every workout is another opportunity to separate yourself.","Excellence isn't an event—it's a lifestyle.","Champions keep moving forward.","Every finish prepares you for the next challenge.","Greatness begins again tomorrow.","Champions respect the journey.","Every workout is another step toward mastery.","Stay consistent. That's what champions do.","You trained like a champion today.","Champions will see you at the next workout.","Momentum starts with one completed workout.","Don't stop now. You're building something great.","Every workout makes the next one easier.","One day at a time. One workout at a time.","Momentum loves consistency.","Keep the streak alive.","You're closer today than yesterday.","Small victories create unstoppable momentum.","The hardest part is showing up—and you did.","Every finish fuels the next beginning.","Keep moving forward.","One more day invested.","Progress loves persistence.","Your momentum is becoming your strength.","Don't lose what you built today.","Today's victory becomes tomorrow's confidence.","Keep stacking successful days.","Every finish creates another opportunity.","You didn't come this far to stop now.","Another workout. Another step forward.","Stay in motion.","Every session adds to your momentum.","The next workout starts with today's finish.","Consistency builds unstoppable progress.","One workout rarely changes everything.","Hundreds of workouts do.","The chain grows stronger.","Keep adding another link.","Great progress never happens all at once.","It happens again tomorrow.","You're creating a rhythm.","Stay in it.","Success belongs to those who return.","Build momentum before motivation.","Keep showing yourself what's possible.","Every session pushes the needle forward.","One more victory collected.","Keep collecting them.","You're moving in the right direction.","Don't interrupt your momentum.","Every workout strengthens your routine.","Success has a rhythm.","You're finding yours.","Every finish is another reason to keep going.","Keep building your streak.","Today's effort deserves tomorrow's effort.","Progress accelerates through consistency.","Keep the wheels turning.","Keep climbing.","One step never seems like much until you look back.","The best momentum is earned.","Every workout keeps the fire alive.","Stay committed to the next session.","You built momentum today.","Protect it.","Small actions create lasting change.","Keep adding to your progress.","Today's finish is tomorrow's head start.","Every workout moves the finish line closer.","Build a routine that carries you.","Momentum beats motivation.","Keep moving.","Every session counts.","Don't break the chain.","Keep earning another day.","Another workout completed.","Another reason to believe.","Every finish builds another beginning.","Progress is earned one session at a time.","You're building something that lasts.","Stay the course.","Every workout reinforces success.","Keep making tomorrow easier.","You're becoming impossible to stop.","Momentum isn't luck.","It's repetition.","Every completed workout makes quitting less likely.","One more day stronger.","One more day wiser.","One more day committed.","Every finish creates confidence.","Every workout strengthens your future.","Keep moving toward the person you're becoming.","Progress isn't a sprint.","It's a return.","Keep returning.","Every session adds another layer of success.","You already won today.","Come back tomorrow and win again.","The next chapter starts with your next workout.","Stay consistent.","Stay patient.","Stay moving.","We'll be here for your next victory.","Recovery is where today's work becomes tomorrow's strength.","You've done the work. Now let your body do the rest.","Recovery is part of the workout.","Rest with purpose.","Growth is already happening.","Every great workout deserves great recovery.","Your muscles recover. Your discipline remains.","Strong bodies are built during recovery.","Today's effort deserves tomorrow's energy.","Refuel. Recover. Return stronger.","The work doesn't stop when the workout ends.","Respect your recovery as much as your training.","Give your body what it needs to grow.","Recovery is an investment, too.","Progress continues while you rest.","Rest isn't quitting. It's preparing.","Recovery fuels consistency.","Recover well. Come back better.","Every champion respects recovery.","Sleep is part of the training plan.","Your body is rebuilding itself right now.","Strength grows after the workout.","Take care of the body that takes care of you.","Recovery isn't optional. It's essential.","Eat well. Sleep well. Train well.","Every workout deserves proper recovery.","Great performance begins with great recovery.","The strongest people know when to recover.","Recharge with purpose.","Respect the process—even the quiet part.","Your body is earning today's effort.","Healing is progress.","Recovery prepares you for the next challenge.","You earned this recovery.","Rest today. Rise tomorrow.","Progress needs recovery to survive.","Refuel your body. Refocus your mind.","Strength isn't rushed.","Recovery is where consistency wins.","Listen to your body.","Recovery is discipline in another form.","The next workout begins with today's recovery.","Great workouts deserve great nutrition.","Your future performance starts now.","Every healthy choice after your workout matters.","Rebuild stronger.","Recovery protects your progress.","Stay hydrated. Stay ready.","The best athletes recover with intention.","Give your body permission to grow.","Recovery is productive.","Growth loves patience.","Great things happen while you're resting.","The strongest muscles were once recovering.","Respect today's effort with tomorrow's recovery.","Recovery turns effort into results.","Good recovery creates great performance.","Don't skip the part that builds strength.","Every meal after training matters.","Sleep is your silent coach.","Recovery keeps you in the game.","The work continues beneath the surface.","Refuel your future.","Recovery isn't a break from progress.","It is progress.","Breathe deeply. Recover completely.","Recovery is earned.","So are results.","Strong habits include recovery.","Great athletes respect their limits.","Tomorrow's energy depends on today's recovery.","Honor the work you completed.","Give your body time to respond.","Progress grows in recovery.","Rest isn't weakness.","It's wisdom.","Let today's effort become tomorrow's strength.","Every recovery day has a purpose.","Recovery completes the workout.","Treat your body like someone you want to become.","Nutrition is part of your success story.","Hydration is another form of discipline.","Be proud of today's work.","Now recover like it matters.","Take care of yourself with the same discipline you train with.","Strong people recover well.","Every hour of sleep supports your goals.","Recovery rewards consistency.","The strongest version of you is rebuilding.","You trained hard.","Now recover smart.","Great work deserves great care.","Keep preparing for tomorrow.","Respect your body.","It carried you through today.","Recover with intention.","Return with confidence.","We'll see you stronger tomorrow.","Master yourself, and everything else becomes easier.","Every disciplined choice strengthens your character.","The hardest battle is often the one within.","Your habits reveal your priorities.","The strongest person is the one who controls themselves.","Victory begins long before the finish line.","Every workout is another opportunity to practice discipline.","Comfort is expensive. Growth is priceless.","The life you want is waiting on the other side of consistency.","Discipline is choosing what matters most.","Every promise you keep becomes part of your character.","The strongest minds embrace difficult things.","You don't become stronger by avoiding resistance.","Every challenge introduces you to yourself.","The easy path rarely leads anywhere worth going.","What you repeat becomes who you are.","Every workout teaches your mind to lead your body.","Excellence is built before it's recognized.","Strength begins with self-control.","Every decision carries tomorrow inside it.","The strongest victories require no audience.","Character is revealed through consistency.","Every completed workout is evidence of your commitment.","Discipline doesn't ask how you feel.","It asks who you want to become.","The strongest foundation is integrity.","Progress belongs to those who stay the course.","Your future respects today's discipline.","Great people honor small commitments.","You owe your future another good decision.","Growth begins where excuses end.","The strongest people don't seek comfort.","They seek purpose.","Nothing worth building comes quickly.","Strength is quiet.","Discipline is quieter.","Let your actions speak first.","Every workout is another chance to practice excellence.","Confidence grows from action, not intention.","Greatness is earned in ordinary moments.","You become stronger every time you keep your word.","Your character grows with every commitment you honor.","The strongest chains are built one link at a time.","So are great lives.","Every workout is another opportunity to choose your future.","Your excuses don't define you.","Your actions do.","Every disciplined day becomes part of your identity.","Keep becoming impossible to discourage.","The greatest competition is yesterday's version of yourself.","Strength begins with one decision.","Repeat it tomorrow.","Every workout reinforces your standards.","Success begins long before anyone notices.","Your future is watching today's choices.","Every session sharpens your discipline.","The strongest people master consistency.","One disciplined day becomes a disciplined life.","Every finish teaches perseverance.","Greatness grows through repetition.","Let your habits become your legacy.","Nothing builds confidence like keeping your word.","Every rep is another lesson.","Stay disciplined.","The work is changing you.","Quietly.","Permanently.","Every session is another victory over comfort.","Great lives are built by ordinary discipline.","The strongest person you know started somewhere.","So did you.","The journey rewards those who remain.","Discipline creates options.","Consistency creates freedom.","Character creates legacy.","Every workout builds all three.","Become someone your future self admires.","Earn your confidence.","Protect your discipline.","Respect your journey.","Never stop becoming.","Tomorrow is another opportunity you've already proven you're ready for."];
  ...
  return(
    <div style={{height:"100dvh",background:t.bg,fontFamily:"Poppins,system-ui,sans-serif",color:t.text,margin:0,overflow:"hidden",display:"flex",flexDirection:"column"}}>
                ...
                <div key={ex.id||("p"+exIdx)} data-excard style={{background:finished?t.cardActive:t.card,border:"1px solid "+(finished?t.accentSolid:t.cardBorder),borderRadius:20,padding:"16px",opacity:1,position:"relative",zIndex:dragIndex===exIdx?60:1,transform:dragIndex===exIdx?"scale(1.03)":"none",boxShadow:dragIndex===exIdx?"0 16px 38px rgba(0,0,0,0.6)":"none",transition:dragIndex===exIdx?"transform 0.12s ease":"all 0.15s",outline:dragOver===exIdx&&dragIndex!==exIdx?"3px solid "+t.accentSolid:"none",outlineOffset:2}}>
                  ...
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:12}}>
                    <div>
                      ...
                      <div style={{fontSize:12,color:theme==="light"?"#000":"#fff",marginTop:3,textShadow:theme==="light"?"none":"0 1px 4px rgba(0,0,0,0.8)"}}>{setCount} sets · target {ex.reps} reps · {done}/{setCount} done{ex.sg?(" · superset "+ex.sg):(ex.ss?" · superset":"")}{ex.tempo?" · tempo "+ex.tempo:""}{ex.rest?" · rest "+ex.rest:""}{(()=>{const ww=ex.pct?workWeight(ex):null;return ww?(ww.need?" · "+ww.wp+"% 1RM · set your max below":" · "+ww.wp+"% → "+ww.weight+" lb"):"";})()}</div>
                    </div>
      ...
      {/* CONGRATS */}
      {showCongrats&&(()=>{const q=getQuote();return <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.85)",backdropFilter:"blur(16px)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:600,padding:"24px"}} onClick={()=>setShowCongrats(false)}><div onClick={e=>e.stopPropagation()} style={{width:"100%",maxWidth:380,background:"radial-gradient(120% 80% at 50% 0%, rgba(212,175,55,0.14) 0%, rgba(212,175,55,0) 46%), linear-gradient(160deg,#1A1A1A 0%,#0B0B0B 100%)",border:"1px solid rgba(212,175,55,0.4)",borderRadius:24,padding:"36px 28px",textAlign:"center",boxShadow:"0 20px 60px rgba(0,0,0,0.6)"}}><div style={{marginBottom:18,display:"flex",justifyContent:"center"}}><svg width="84" height="84" viewBox="0 0 96 96"><circle cx="48" cy="50" r="20" fill="none" stroke="#D4AF37" strokeWidth="3" strokeLinecap="round" style={{strokeDasharray:126,strokeDashoffset:126,animation:"fsdraw 0.6s ease forwards"}} /><path d="M38 50 L46 58 L61 39" fill="none" stroke="#D4AF37" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" style={{strokeDasharray:42,strokeDashoffset:42,animation:"fsdraw 0.45s ease 0.5s forwards"}} /><path d="M30 73 Q15 50 26 25" fill="none" stroke="#D4AF37" strokeWidth="2.5" strokeLinecap="round" /><path d="M66 73 Q81 50 70 25" fill="none" stroke="#D4AF37" strokeWidth="2.5" strokeLinecap="round" /><g fill="#D4AF37"><ellipse cx="22" cy="60" rx="3.6" ry="2.1" transform="rotate(40 22 60)" /><ellipse cx="19" cy="47" rx="3.6" ry="2.1" transform="rotate(25 19 47)" /><ellipse cx="21" cy="34" rx="3.6" ry="2.1" transform="rotate(10 21 34)" /><ellipse cx="74" cy="60" rx="3.6" ry="2.1" transform="rotate(-40 74 60)" /><ellipse cx="77" cy="47" rx="3.6" ry="2.1" transform="rotate(-25 77 47)" /><ellipse cx="75" cy="34" rx="3.6" ry="2.1" transform="rotate(-10 75 34)" /></g></svg></div><div style={{fontSize:26,fontWeight:900,color:"#f8fafc",marginBottom:8,letterSpacing:2,fontFamily:"Montserrat,sans-serif",textTransform:"uppercase"}}>Workout Complete</div><div style={{fontSize:12,color:"#D4AF37",fontWeight:700,letterSpacing:3,textTransform:"uppercase",marginBottom:24,fontFamily:"Montserrat,sans-serif"}}>{FULL_DAYS[DAYS.indexOf(selectedDay)]}</div><div style={{background:"rgba(212,175,55,0.07)",border:"1px solid rgba(212,175,55,0.25)",borderRadius:16,padding:"18px 20px",marginBottom:28}}><div style={{fontSize:16,color:"#EDEDED",lineHeight:1.6,fontStyle:"italic",fontFamily:"Georgia,serif"}}>"{q}"</div></div><div style={{display:"flex",flexDirection:"column",gap:10}}><button onClick={()=>{setShowCongrats(false);setShowStats(true);}} style={{width:"100%",padding:"14px",background:"linear-gradient(135deg,#D4AF37 0%,#F5E070 45%,#D4AF37 60%,#B8941F 100%)",border:"none",borderRadius:14,color:"#0B0B0B",fontSize:14,fontWeight:800,cursor:"pointer",letterSpacing:1,fontFamily:"Montserrat,sans-serif",textTransform:"uppercase"}}>View My Stats</button><button onClick={()=>setShowCongrats(false)} style={{width:"100%",padding:"14px",background:"transparent",border:"1px solid rgba(212,175,55,0.25)",borderRadius:14,color:"#9a9a9a",fontSize:14,fontWeight:600,cursor:"pointer",letterSpacing:1}}>Done</button></div></div></div>;})()}

      {/* STATS MODAL */}
      {showStats&&<div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.8)",backdropFilter:"blur(10px)",display:"flex",alignItems:"flex-end",justifyContent:"center",zIndex:200}} onClick={()=>setShowStats(false)}><div onClick={e=>e.stopPropagation()} style={{width:"100%",maxWidth:480,background:"radial-gradient(120% 45% at 50% 0%, rgba(212,175,55,0.10) 0%, rgba(212,175,55,0) 42%), linear-gradient(180deg,#161616 0%,#0B0B0B 100%)",borderRadius:"24px 24px 0 0",padding:"24px 20px 44px",border:"1px solid rgba(212,175,55,0.3)",borderBottom:"none",maxHeight:"85vh",overflowY:"auto"}}><div style={{width:40,height:4,background:"rgba(212,175,55,0.5)",borderRadius:2,margin:"0 auto 20px"}} /><div style={{display:"flex",alignItems:"center",gap:10,marginBottom:4}}><svg width="30" height="30" viewBox="0 0 96 96"><circle cx="48" cy="50" r="20" fill="none" stroke="#D4AF37" strokeWidth="4" /><path d="M38 50 L46 58 L61 39" fill="none" stroke="#D4AF37" strokeWidth="4.5" strokeLinecap="round" strokeLinejoin="round" /><path d="M30 73 Q15 50 26 25" fill="none" stroke="#D4AF37" strokeWidth="3" strokeLinecap="round" /><path d="M66 73 Q81 50 70 25" fill="none" stroke="#D4AF37" strokeWidth="3" strokeLinecap="round" /></svg><div style={{fontSize:20,fontWeight:800,color:"#FFFFFF",fontFamily:"Montserrat,sans-serif",textTransform:"uppercase",letterSpacing:1}}>Workout Summary</div></div><div style={{fontSize:12,color:"#D4AF37",fontWeight:700,letterSpacing:2,textTransform:"uppercase",marginBottom:20,fontFamily:"Montserrat,sans-serif"}}>{FULL_DAYS[DAYS.indexOf(selectedDay)]}</div><div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:10,marginBottom:20}}>{[{label:"Total Volume",value:stats.totalVolume>0?stats.totalVolume.toLocaleString()+" lbs":"—"},{label:"Total Reps",value:stats.totalReps},{label:"Sets Done",value:stats.totalSets}].map(s=><div key={s.label} style={{background:"#1A1A1A",border:"1px solid rgba(212,175,55,0.25)",borderRadius:14,padding:"14px 8px",textAlign:"center"}}><div style={{fontSize:18,fontWeight:800,color:"#D4AF37",fontFamily:"Montserrat,sans-serif"}}>{s.value}</div><div style={{fontSize:10,color:"#8a8a8a",marginTop:4,letterSpacing:0.5}}>{s.label}</div></div>)}</div>{stats.exStats.map((ex,idx)=><div key={idx} style={{background:"#161616",border:"1px solid rgba(212,175,55,0.12)",borderRadius:14,padding:"12px 14px",marginBottom:10}}><div style={{fontSize:15,fontWeight:700,color:"#EDEDED",marginBottom:8,fontFamily:"Montserrat,sans-serif"}}>{ex.name}</div><div style={{display:"flex",gap:16,flexWrap:"wrap"}}><div><span style={{fontSize:11,color:"#8a8a8a"}}>Volume </span><span style={{fontSize:13,fontWeight:700,color:"#EDEDED"}}>{ex.volume>0?ex.volume.toLocaleString()+" lbs":"—"}</span></div><div><span style={{fontSize:11,color:"#8a8a8a"}}>Reps </span><span style={{fontSize:13,fontWeight:700,color:"#EDEDED"}}>{ex.reps}</span></div>{ex.bestSet&&ex.bestSet.weight>0&&<div><span style={{fontSize:11,color:"#8a8a8a"}}>Best </span><span style={{fontSize:13,fontWeight:700,color:"#D4AF37"}}>S{ex.bestSet.set}: {ex.bestSet.reps}r × {ex.bestSet.weight}lbs</span></div>}</div></div>)}<button onClick={()=>setShowStats(false)} style={{width:"100%",marginTop:20,padding:"15px",background:"linear-gradient(135deg,#D4AF37 0%,#F5E070 45%,#D4AF37 60%,#B8941F 100%)",border:"none",borderRadius:14,color:"#0B0B0B",fontSize:15,fontWeight:800,cursor:"pointer",letterSpacing:1,fontFamily:"Montserrat,sans-serif",textTransform:"uppercase"}}>Done</button></div></div>}
